...
const Footer = () => {
  return (
    <footer className=" bg-primary text-text-alt px-1 md:px-0">
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-start gap-8">
            ...
            <div className="flex-shrink-0 mb-3 ">
              <Link to={`/`}>
                <svg
                  ...
                  viewBox="0 0 463 314"
                  className="w-20 h-auto text-text-alt transition-all duration-300"
                  fill="currentColor"
                  style={{
          ...
          <div className="flex flex-col items-center">
            <ul className="space-y-2 text-lg">
              <li className="font-semibold">Навигация</li>
              <li>
                <Link
                  to={`/`}
          ...
          >
            <ul className="space-y-2 text-lg">
              ...
              <li>
                <a
                  href={`mailto:spicery@gmail.com`}
                  className="relative inline-block after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-current after:transition-all after:duration-300 after:ease-in-out hover:after:w-full"
                >
                  spicery@gmail.com
                </a>
              </li>
              <li className="flex space-x-4 mt-2 justify-start">
